...
const defaultTranslations: Translations = {
  en: {
    ...
    // "productCountSingular": "product", // Already defined
    // "productCountPlural": "{{count}} products", // Already defined
    ...
    // "reviewCount": "{{count}} reviews", // Already defined
    "rateIt": "Rate It",
    ...
    "bestpriceGive": "BestPrice Give",
    "footerBestPriceSectionTitle": "BestPrice",
    "aboutUs": "About Us",                       "ourBlog": "Our Blog",
    "buyingGuides": "Buying Guides",             "purchaseInsurance": "Purchase Insurance",
    "advertising": "Advertising",
    "bestpriceCertification": "BestPrice Certification",
  ...
  el: {
    ...
    // ============================ Vendor Page ===================================
    "loadingVendor": "Φόρτωση καταστήματος...",
    "allStores": "Καταστήματα",
    ...
    "authorizedReseller": "Εξουσιοδοτημένος Μεταπωλητής",
    ...
    "bestpriceCertification": "Πιστοποίηση BestPrice",
  ...
  es: {
    ...
    "bestpriceSloganLong": "BestPrice es el primer y más grande servicio de comparación de precios en España.", // Adjusted for context
    ...
    "bestpriceCertification": "Certificación BestPrice",
    ...
    "gdprLink": "RGPD",                          "dsaLink": "LSD", // Ley de Servicios Digitales
  ...
  fr: {
    ...
    "bestpriceSloganLong": "BestPrice est le premier et le plus grand service de comparaison de prix en France.", // Adjusted for context
    ...
    "bestpriceCertification": "Certification BestPrice",
    ...
    "gdprLink": "RGPD",                          "dsaLink": "LSD", // Loi sur les Services Numériques
  ...
  de: {
    ...
    "bestpriceSloganLong": "BestPrice ist der erste und größte Preisvergleichsdienst in Deutschland.", // Adjusted for context
    ...
    "advertising": "Werbung",
    "bestpriceCertification": "BestPrice Zertifizierung",
    ...
    "gdprLink": "DSGVO",                         "dsaLink": "DSA", // Digital Services Act
