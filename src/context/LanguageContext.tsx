...
const defaultTranslations: Translations = {
  en: {
    ...
    recently_viewed_title: "Recently Viewed",   // Duplicate, also in Categories section
    ...
    "remove_nearby_filter": "Remove 'Nearby' filter",
    ...
    "storesCount": "Stores ({{count}})",         "clearPriceFilters": "Clear filters", // Already exists
    // "finalPrice" is already defined         "available": "Available", // For price filters
    "nearMe": "Near Me",
    // "certified" is already defined
    ...
    "outOfStock": "Out of Stock",                // "inStock" is already defined
    ...
    "share": "Share",                            // "addToFavorites" is already defined
    "removeFromFavorites": "Remove from Favorites",
    "priceHistory": "Price History",             // "priceDropAlert" is already defined
    "certifiedStoresTooltip": "Show only products from certified stores", // Tooltip for certified filter
    // For Vendor Popup
    ...
    // Toast Messages for Product Detail
    "loginRequired": "Login Required", // General, but used in ProductDetail
    ...
    "paymentMethod_pickup_via": "Pickup via Courier/Service", // For PaymentMethod.PickupVia

    // ============================== Category Slugs ============================
    // --- Main Categories ---
    'technology': 'Technology',                  'home-garden': 'Home & Garden',
    'fashion': 'Fashion',                        'health-beauty': 'Health & Beauty',
    'kids-baby': 'Kids & Baby',                  'hobby-sports': 'Hobby & Sports',
    'auto-moto': 'Auto & Moto',
    // --- Subcategories ---
    'mobile-telephony': 'Mobile Telephony',      'computers': 'Computers',
    'laptops-accessories': 'Laptops & Accessories', 'visual': 'Visual',
    'smartwatches-wearables': 'Smartwatches & Wearables', 'tablets-accessories': 'Tablets & Accessories',
    'video-games': 'Video Games',                'audio': 'Audio',
    'photo-video': 'Photo & Video',              'electronics': 'Electronics',
    'telephony': 'Telephony',                    'gadgets': 'Gadgets',
    'home-appliances': 'Home Appliances',        'tools': 'Tools',
    'furniture': 'Furniture',                    'garden': 'Garden',
    'home-items': 'Home Items',                  'linens': 'Linens',
    'lighting': 'Lighting',                      'kitchenware': 'Kitchenware',
    'food-beverages': 'Food & Beverages',        'electrical-supplies': 'Electrical Supplies',
    'smoking-accessories': 'Smoking Accessories', 'office-supplies': 'Office Supplies',
    'gift-items': 'Gift Items',                  'security-systems': 'Security Systems',
    'professional-equipment': 'Professional Equipment', 'seasonal-items': 'Seasonal Items',
    'shopping-bags': 'Shopping Bags',            'shopping-trolleys': 'Shopping Trolleys',
    'church-items': 'Church Items',              'pet-supplies': 'Pet Supplies',
    'womens-fashion': "Women's Fashion",          'mens-fashion': "Men's Fashion",
    'watches': 'Watches',                        'jewelry': 'Jewelry',
    'eyewear': 'Eyewear',                        'converse-all-star': 'Converse All Star',
    'rain-umbrellas': 'Rain Umbrellas',          'shoe-accessories': 'Shoe Accessories',
    'kids-baby-fashion': "Kids & Baby Fashion",  'sneakers': 'Sneakers',
    'grooming': 'Grooming',                      'pharmacy-products': 'Pharmacy Products',
    'perfumes': 'Perfumes',                      'dietary-supplements': 'Dietary Supplements',
    'grooming-devices': 'Grooming Devices',      'makeup': 'Makeup',
    'sunscreen-tanning': 'Sunscreen & Tanning',  'medical-supplies': 'Medical Supplies',
    'manicure-pedicure': 'Manicure & Pedicure',  'oral-hygiene': 'Oral Hygiene',
    'sex-toys': 'Sex Toys',                      'firming-slimming': 'Firming & Slimming',
    'cannabis-products': 'Cannabis Products',    'orthopedics': 'Orthopedics',
    'patient-aids': 'Patient Aids',              'optics': 'Optics',
    'korean-cosmetics': 'Korean Cosmetics',
    'kids-toys': "Kids' Toys",                   'school-supplies': 'School Supplies',
    'baby-toys': 'Baby Toys',                    'baby-items': 'Baby Items',
    'kids-linens': "Kids' Linens",               'christening-items': 'Christening Items',
    'kids-watches': "Kids' Watches",
    'sports': 'Sports',                          'cycling': 'Cycling',
    'leisure-time': 'Leisure Time',              'fishing-diving': 'Fishing & Diving',
    'beach-sea-items': 'Beach & Sea Items',      'camping': 'Camping',
    'travel-items-bags': 'Travel Items & Bags',  'books': 'Books',
    'hunting': 'Hunting',                        'fitness-equipment': 'Fitness Equipment',
    'pet-supplies-hobby': 'Pet Supplies (Hobby)', 'drones-accessories': 'Drones & Accessories',
    'electric-scooters': 'Electric Scooters',    'hoverboards': 'Hoverboards',
    'musical-instruments': 'Musical Instruments', 'sports-accessories': 'Sports Accessories',
    ...
    'boat': 'Boat',                              'truck-items': 'Truck Items',
    'smartphones': 'Smartphones',                'iphone': 'iPhone',
    'mobile-cases': 'Mobile Cases',              'bluetooth-handsfree': 'Bluetooth Handsfree',
    'handsfree': 'Handsfree',                    'mobile-chargers': 'Mobile Chargers',
    'tempered-glass': 'Tempered Glass',          'screen-protectors': 'Screen Protectors',
    'power-banks': 'Power Banks',                'mobile-batteries': 'Mobile Batteries',
    'selfie-sticks': 'Selfie Sticks',            'mobile-holders': 'Mobile Holders',
    'charging-data-cables': 'Charging & Data Cables', 'anti-lost-trackers': 'Anti-Lost Trackers',
    'mobile-spare-parts': 'Mobile Spare Parts',  'mobile-gimbals': 'Mobile Gimbals',
    'stylus-pens': 'Stylus Pens',                'stylus-accessories': 'Stylus Accessories',
    'bluetooth-headset-accessories': 'Bluetooth Headset Accessories',
    'anti-lost-tracker-accessories': 'Anti-Lost Tracker Accessories',
    'pop-sockets': 'Pop Sockets',                'mobile-tripods': 'Mobile Tripods',
    'mobile-service-tools': 'Mobile Service Tools', 'mobile-charms': 'Mobile Charms',
    ...
    'ps5-games': 'PS5 Games',                    'pc-games': 'PC Games',
  ...
  el: {
    ...
    "storesCount": "Καταστήματα ({{count}})",     "clearPriceFilters": "Καθαρισμός φίλτρων",
    ...
    "outOfStock": "Εξαντλημένο",                // "inStock" is already defined
    ...
    "share": "Κοινοποίηση",                      // "addToFavorites" is already defined
    "removeFromFavorites": "Αφαίρεση από τα Αγαπημένα",
    "priceHistory": "Ιστορικό Τιμών",           // "priceDropAlert" is already defined
    ...
    // ============================== Category Slugs ============================
    // --- Main Categories ---
    'technology': 'Τεχνολογία',                  'home-garden': 'Σπίτι & Κήπος',
    'fashion': 'Μόδα',                        'health-beauty': 'Υγεία & Ομορφιά',
    'kids-baby': 'Παιδικά - Βρεφικά',          'hobby-sports': 'Hobby, Αθλητισμός',
    'auto-moto': 'Μηχανοκίνηση',
    // --- Subcategories ---
    'mobile-telephony': 'Κινητή Τηλεφωνία',      'computers': 'Υπολογιστές',
    'laptops-accessories': 'Laptops, Αξεσουάρ', 'visual': 'Εικόνα',
    'smartwatches-wearables': 'Smartwatches, Wearables', 'tablets-accessories': 'Tablets, Αξεσουάρ',
    'video-games': 'Video Games',                'audio': 'Ήχος',
    'photo-video': 'Φωτογραφία, Video',          'electronics': 'Ηλεκτρονικά',
    'telephony': 'Τηλεφωνία',                    'gadgets': 'Gadgets',
    'home-appliances': 'Οικιακές Συσκευές',    'tools': 'Εργαλεία',
    'furniture': 'Έπιπλα',                        'garden': 'Κήπος',
    'home-items': 'Είδη Σπιτιού',              'linens': 'Λευκά Είδη',
    'lighting': 'Φωτισμός',                      'kitchenware': 'Είδη Κουζίνας',
    'food-beverages': 'Τρόφιμα & Ποτά',        'electrical-supplies': 'Ηλεκτρολογικά',
    'smoking-accessories': 'Είδη Καπνιστού',     'office-supplies': 'Είδη Γραφείου',
    'gift-items': 'Είδη Δώρων',                  'security-systems': 'Συστήματα Ασφαλείας',
    'professional-equipment': 'Επαγγελματικός Εξοπλισμός', 'seasonal-items': 'Εποχιακά Είδη',
    'shopping-bags': 'Τσάντες για Ψώνια',        'shopping-trolleys': 'Καρότσια Λαϊκής',
    'church-items': 'Εκκλησιαστικά Είδη',      'pet-supplies': 'Είδη Κατοικιδίων',
    'womens-fashion': 'Γυναικεία Μόδα',          'mens-fashion': 'Ανδρική Μόδα',
    'watches': 'Ρολόγια',                        'jewelry': 'Κοσμήματα',
    'eyewear': 'Οπτικά',                        'converse-all-star': 'Converse All Star',
    'rain-umbrellas': 'Ομπρέλες Βροχής',          'shoe-accessories': 'Αξεσουάρ Παπουτσιών',
    'kids-baby-fashion': 'Παιδική, Βρεφική Μόδα', 'sneakers': 'Sneakers: Τα πιο trendy παπούτσια για κάθε στυλ και περίσταση!',
    'grooming': 'Περιποίηση',                  'pharmacy-products': 'Είδη Φαρμακείου',
    'perfumes': 'Αρώματα',                      'dietary-supplements': 'Συμπληρώματα Διατροφής',
    'grooming-devices': 'Συσκευές Περιποίησης',  'makeup': 'Μακιγιάζ',
    'sunscreen-tanning': 'Αντηλιακή Προστασία, Μαύρισμα', 'medical-supplies': 'Ιατρικά Είδη',
    'manicure-pedicure': 'Μανικιούρ - Πεντικιούρ', 'oral-hygiene': 'Στοματική Υγιεινή',
    'sex-toys': 'Sex Toys',                      'firming-slimming': 'Σύσφιξη, Αδυνάτισμα',
    'cannabis-products': 'Προϊόντα Κάνναβης',    'orthopedics': 'Ορθοπεδικά',
    'patient-aids': 'Βοηθήματα Ασθενών',          'optics': 'Οπτικά',
    'korean-cosmetics': 'Κορεάτικα Καλλυντικά',
    'kids-toys': 'Παιδικά Παιχνίδια',           'school-supplies': 'Σχολικά Είδη',
    'baby-toys': 'Βρεφικά Παιχνίδια',            'baby-items': 'Βρεφικά Είδη',
    'kids-linens': 'Παιδικά Λευκά Είδη',           'christening-items': 'Βαπτιστικά',
    'kids-watches': 'Παιδικά Ρολόγια',
    'sports': 'Αθλήματα',                      'cycling': 'Ποδηλασία',
    'leisure-time': 'Ελεύθερος Χρόνος',          'fishing-diving': 'Ψάρεμα, Καταδύσεις',
    'beach-sea-items': 'Είδη Θαλάσσης',          'camping': 'Camping',
    'travel-items-bags': 'Είδη Ταξιδίου, Τσάντες', 'books': 'Βιβλία',
    'hunting': 'Κυνήγι',                        'fitness-equipment': 'Είδη Γυμναστικής',
    'pet-supplies-hobby': 'Είδη Κατοικιδίων (Hobby)', 'drones-accessories': 'Drones & Αξεσουάρ',
    'electric-scooters': 'Ηλεκτρικά Πατίνια',    'hoverboards': 'Hoverboards',
    'musical-instruments': 'Μουσικά Όργανα',     'sports-accessories': 'Αξεσουάρ Αθλημάτων',
    ...
    'car': 'Αυτοκίνητο',                        'motorcycle': 'Μοτοσυκλέτα',
    'boat': 'Σκάφος',                          'truck-items': 'Είδη Φορτηγού',
    'smartphones': 'Κινητά',                    'iphone': 'iPhone',
    'mobile-cases': 'Θήκες Κινητών',              'bluetooth-handsfree': 'Bluetooth Handsfree',
    'handsfree': 'Handsfree',                    'mobile-chargers': 'Φορτιστές Κινητών',
    'tempered-glass': 'Tempered Glass',          'screen-protectors': 'Προστασία Οθόνης',
    'power-banks': 'Power Banks',                'mobile-batteries': 'Μπαταρίες Κινητών',
    'selfie-sticks': 'Selfie Stick',            'mobile-holders': 'Βάσεις Κινητού',
    'charging-data-cables': 'Καλώδια Φόρτισης, Μεταφοράς Δεδομένων', 'anti-lost-trackers': 'Anti-Lost Tracker',
    'mobile-spare-parts': 'Ανταλλακτικά Κινητών', 'mobile-gimbals': 'Gimbal Κινητών',
    'stylus-pens': 'Γραφίδες Αφής',              'stylus-accessories': 'Αξεσουάρ Γραφίδας',
    'bluetooth-headset-accessories': 'Αξεσουάρ Ακουστικών Bluetooth',
    'anti-lost-tracker-accessories': 'Αξεσουάρ Anti-Lost Tracker',
    'pop-sockets': 'Pop Sockets',                'mobile-tripods': 'Τρίποδα Κινητών',
    'mobile-service-tools': 'Εργαλεία για Service Κινητών', 'mobile-charms': 'Διακοσμητικά Κινητών',
  ...
  es: {
    ...
    register: 'Registrarse', signIn: 'Iniciar sesión', loggingIn: 'Iniciando sesión...',
    // ... [Copy and translate ALL keys from 'en' section to 'es'] ...
    "product_singular": "producto", "product_plural": "{{count}} productos",
    "rating_label": "Clasificación", "reviews_label_singular": "reseña",
    ...
    "breadcrumbHome": "BestPrice", // or "Inicio"
    ...
    "storesCount": "Tiendas ({{count}})", "clearPriceFilters": "Limpiar filtros",
  ...
  fr: {
    ...
    "filters_title": "Filtres", "remove_all_filters_tooltip": "Supprimer tous les filtres",
    ...
    "addToShoppingList": "Ajouter à la Liste d'Achats", "addToComparison": "Ajouter à la Comparaison",
    "iWantIt": "Je le Veux", "iHaveIt": "Je l'ai",
    "notifyPriceDrop": "Notifier en cas de baisse de prix", "addToCollection": "Ajouter à la Collection",
    "priceFrom": "À partir de", "inStores": "dans {{count}} magasins",
    "storesCount": "Magasins ({{count}})", "clearPriceFilters": "Effacer les filtres",
    "available": "Disponible", "nearMe": "Près de Moi",
    "deliveryWithService": "Livraison avec {{serviceName}}",
    "coupons": "Coupons", "color": "Couleur",
    "officialResellers": "Revendeurs Officiels", "priceHistoryTitle": "Historique des Prix",
    "productDetails": "Détails du Produit", "userReviews": "Avis des Utilisateurs ({{count}})",
    "questionsAndAnswers": "Questions & Réponses ({{count}})",
    "similarProducts": "Produits Similaires", "dealsInCategory": "Promotions dans {{categoryName}}",
    "addToCart": "Ajouter au Panier", "buyNow": "Acheter Maintenant",
    "specifications": "Spécifications", "reviews": "Avis",
    "relatedProducts": "Produits Connexes", "writeReview": "Écrire un Avis",
    "outOfStock": "Épuisé",
    "availableAt": "Disponible dans {{count}} magasins", "noStoresAvailable": "Actuellement indisponible",
    "priceRange": "Fourchette de Prix", "comparePrices": "Comparer {{count}} Prix",
    "viewAllStores": "Voir tous les magasins", "productDescription": "Description",
    "share": "Partager", "addToFavorites": "Ajouter aux Favoris",
    "removeFromFavorites": "Retirer des Favoris", "priceHistory": "Historique des Prix",
    "certifiedStoresTooltip": "Afficher uniquement les produits des magasins certifiés",
    "vendorPopupCertification": "Certification : {{certificationType}}",
    "vendorPopupInformation": "Informations", "vendorPopupAddressNotAvailable": "Boutique en Ligne Uniquement",
    "vendorPopupPaymentMethods": "MÉTHODES DE PAIEMENT",
    "vendorPopupLearnMore": "En Savoir Plus", "vendorPopupViewInStore": "Voir en Magasin",
    "openingHoursNotAvailable": "Informations sur les heures d'ouverture non disponibles",
    "closedToday": "Fermé aujourd'hui", "openUntil": "Ouvert jusqu'à {{time}}",
    "closedOpensAt": "Fermé - Ouvre à {{time}}", "closedForToday": "Fermé pour aujourd'hui",
    "openingHoursError": "Erreur dans les heures d'ouverture",
    "loginRequired": "Connexion Requise",
    "loginToAddToFavorites": "Veuillez vous connecter pour ajouter ce produit à vos favoris",
    "productAddedToFavorites": "{{productName}} a été ajouté à vos favoris",
    "linkCopied": "Lien Copié", "productLinkCopied": "Lien du produit copié dans le presse-papiers",
    "copyFailed": "Échec de la Copie", "couldNotCopyLink": "Impossible de copier le lien",
    "loginToSetPriceAlert": "Veuillez vous connecter pour définir une alerte de prix",
    "paymentMethod_credit_card": "Carte de Crédit", "paymentMethod_bank_transfer": "Virement Bancaire",
    "paymentMethod_paypal": "PayPal", "paymentMethod_cash_on_delivery": "Paiement à la Livraison",
    "paymentMethod_pickup_from_store": "Retrait en Magasin", "paymentMethod_klarna": "Klarna",
    "paymentMethod_apple_pay": "Apple Pay", "paymentMethod_google_pay": "Google Pay",
    "paymentMethod_ideal": "iDEAL", "paymentMethod_crypto": "Cryptomonnaie",
    "paymentMethod_pay_by_link": "Payer par Lien", "paymentMethod_pickup_via": "Retrait via Coursier/Service",
    'technology': 'Technologie', 'home-garden': 'Maison et Jardin', // ... ALL CATEGORY SLUGS ...
  },
  // ============================ German (de) - PLEASE VERIFY & COMPLETE =============================
  de: {
    email: 'E-Mail', password: 'Passwort', signIn: 'Anmelden', createAccount: 'Konto erstellen',
    // ... [Copy and translate ALL keys from 'en' section to 'de'] ...
    "product_singular": "Produkt", "product_plural": "{{count}} Produkte",
    "rating_label": "Bewertung", "reviews_label_singular": "Bewertung",
    ...
    "filters_title": "Filter", "remove_all_filters_tooltip": "Alle Filter entfernen",
    ...
    "loadingProduct": "Produkt Lädt...",
    "addToShoppingList": "Zur Einkaufsliste Hinzufügen", "addToComparison": "Zum Vergleich Hinzufügen",
    "iWantIt": "Ich Will es", "iHaveIt": "Ich Habe es",
    "notifyPriceDrop": "Bei Preisabfall Benachrichtigen", "addToCollection": "Zur Sammlung Hinzufügen",
    "priceFrom": "Ab", "inStores": "in {{count}} Shops",
    "storesCount": "Shops ({{count}})", "clearPriceFilters": "Filter löschen",
    "available": "Verfügbar", "nearMe": "In meiner Nähe",
    "deliveryWithService": "Lieferung mit {{serviceName}}",
    "coupons": "Gutscheine", "color": "Farbe",
    "officialResellers": "Offizielle Händler", "priceHistoryTitle": "Preisverlauf",
    "productDetails": "Produktdetails", "userReviews": "Nutzerbewertungen ({{count}})",
    "questionsAndAnswers": "Fragen & Antworten ({{count}})",
    "similarProducts": "Ähnliche Produkte", "dealsInCategory": "Angebote in {{categoryName}}",
    "addToCart": "In den Warenkorb", "buyNow": "Jetzt Kaufen",
    "specifications": "Spezifikationen", "reviews": "Bewertungen",
    "relatedProducts": "Ähnliche Produkte", "writeReview": "Bewertung Schreiben",
    "outOfStock": "Ausverkauft",
    "availableAt": "Verfügbar in {{count}} Shops", "noStoresAvailable": "Derzeit nicht verfügbar",
    "priceRange": "Preisspanne", "comparePrices": "{{count}} Preise Vergleichen",
    "viewAllStores": "Alle Shops anzeigen", "productDescription": "Beschreibung",
    "share": "Teilen", "addToFavorites": "Zu Favoriten Hinzufügen",
    "removeFromFavorites": "Aus Favoriten Entfernen", "priceHistory": "Preisverlauf",
    "certifiedStoresTooltip": "Nur Produkte von zertifizierten Shops anzeigen",
    "vendorPopupCertification": "Zertifizierung: {{certificationType}}",
    "vendorPopupInformation": "Informationen", "vendorPopupAddressNotAvailable": "Nur Online-Shop",
    "vendorPopupPaymentMethods": "ZAHLUNGSMETHODEN",
    "vendorPopupLearnMore": "Mehr Erfahren", "vendorPopupViewInStore": "Im Shop Ansehen",
    "openingHoursNotAvailable": "Öffnungszeiten nicht verfügbar",
    "closedToday": "Heute geschlossen", "openUntil": "Geöffnet bis {{time}} Uhr",
    "closedOpensAt": "Geschlossen - Öffnet um {{time}} Uhr", "closedForToday": "Für heute geschlossen",
    "openingHoursError": "Fehler bei Öffnungszeiten",
    "loginRequired": "Anmeldung Erforderlich",
    "loginToAddToFavorites": "Bitte melden Sie sich an, um dieses Produkt zu Ihren Favoriten hinzuzufügen",
    "productAddedToFavorites": "{{productName}} wurde zu Ihren Favoriten hinzugefügt",
    "linkCopied": "Link Kopiert", "productLinkCopied": "Produktlink in die Zwischenablage kopiert",
    "copyFailed": "Kopieren Fehlgeschlagen", "couldNotCopyLink": "Link konnte nicht kopiert werden",
    "loginToSetPriceAlert": "Bitte melden Sie sich an, um einen Preisalarm einzustellen",
    "paymentMethod_credit_card": "Kreditkarte", "paymentMethod_bank_transfer": "Banküberweisung",
    "paymentMethod_paypal": "PayPal", "paymentMethod_cash_on_delivery": "Nachnahme",
    "paymentMethod_pickup_from_store": "Abholung im Geschäft", "paymentMethod_klarna": "Klarna",
    "paymentMethod_apple_pay": "Apple Pay", "paymentMethod_google_pay": "Google Pay",
    "paymentMethod_ideal": "iDEAL", "paymentMethod_crypto": "Kryptowährung",
    "paymentMethod_pay_by_link": "Bezahlen per Link", "paymentMethod_pickup_via": "Abholung per Kurier/Dienst",
