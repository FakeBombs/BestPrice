...
const ProductBreadcrumb = ({ product }: ProductBreadcrumbProps) => {
  ...
  return (
    ...
    <div class="comparison__category">
      <div class="comparison__category-products">
        <div class="tooltip__anchor comparison__category-product">
          <div class="comparison__category-remove">
            <svg class="icon icon--no-margin" aria-hidden="true" width="20" height="20"><use xlink:href="/public/dist/images/icons/icons.svg#icon-round-x-20"></use></svg>
          </div>
      ...
      <a href="/compare/2158420121-2159422084" class="button button--outline comparison__category-link">Σύγκριση (2)</a>
    </div>
    </div>
  );
};
