...
const Footer: React.FC = () => {
  ...
  return (
    <div id="footer-wrapper">
      <div id="back-to-top" className="pressable" onClick={handleClick} style={{display: "flex"}}>Επιστροφή στην κορυφή<svg aria-hidden="true" className="icon" width="12" height="12" viewBox="0 0 12 12" role="img"><path d="M1.41 9.41L6 4.83L10.59 9.41L12 8L6 2L0 8L1.41 9.41Z"/></svg></div>
            ...
            <div className="footer__section">
              ...
              <div className="footer__section-scroller">
                <div className="footer__section-content">
                  <ul>
                    {mainCategories.map(category => ( <li></><Link key={category.id} to={`/cat/${category.id}/${category.slug}.html?bpref=home-verticals`}>{t(category.name)}</Link></li> ))}
