            ...
            <div className="footer__section">
              <div class="footer__section-header">
                ...
                <div class="footer__section-icon">
                  <svg aria-hidden="true" class="icon" width="16" height="16" viewBox="0 0 16 16" role="img"><path xmlns="http://www.w3.org/2000/svg" d="M1 13L9 5L17 13" stroke-linecap="round" stroke-linejoin="round"/></svg>
                </div>
              </div>
