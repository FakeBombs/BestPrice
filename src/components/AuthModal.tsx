  ...
  const renderLoginContent = () => {
    ...
    <div className="login__view login__view--signin">
      ...
      <form method="post" className="login__form" onSubmit={(e) => {e.preventDefault(); handleLogin(e);}}>
        <div  className={`login__field login__field--placeholder-transition login__field--text ${loginEmailFocused ? 'login__field--focused' : ''}`} onClick={() => focusInput('usernameOrEmail')}>
          <Label className="login__input-wrapper">
            <div className="login__field-placeholder" style={{ marginTop: loginEmailFocused ? '-8.2875px' : '-9.75px', transformOrigin: 'left top', transform: loginEmailFocused ? 'scale(0.85) translateY(-33.6765px)' : 'none' }}>Όνομα χρήστη ή e-mail</div>
        ...
        <div className={`login__field login__field--placeholder-transition login__field--password login__field--has-toggler ${loginPasswordFocused ? 'login__field--focused' : ''}`} onClick={() => focusInput('password')}>
          <Label className="login__input-wrapper">
            <div className="login__field-placeholder" style={{ marginTop: loginPasswordFocused ? '-8.2875px' : '-9.75px', transformOrigin: 'left top', transform: loginPasswordFocused ? 'scale(0.85) translateY(-33.6765px)' : 'none' }}>Κωδικός</div>
            <Input type={loginShowPassword ? 'text' : 'password'} value="" name="password" onChange={(e) => setLoginPassword(e.target.value)} autoCapitalize="none" placeholder="" onFocus={() => setLoginPasswordFocused(true)} onBlur={() => setLoginPasswordFocused(false)} />
  ...
  const renderRegisterContent = () => {
    ...
    <div className="login__view">
      ...
      <form method="post" className="login__form" onSubmit={(e) => {e.preventDefault(); handleRegister(e);}}>
        <div  className={`login__field login__field--placeholder-transition login__field--text ${registerEmailFocused ? 'login__field--focused' : ''}`} onClick={() => focusInput('email')}>
          <Label className="login__input-wrapper">
            <div className="login__field-placeholder" style={{ marginTop: registerEmailFocused ? '-8.2875px' : '-9.75px', transformOrigin: 'left top', transform: registerEmailFocused ? 'scale(0.85) translateY(-33.6765px)' : 'none' }}>e-mail</div>
        ...
        <div  className={`login__field login__field--placeholder-transition login__field--text ${registerFirstNameFocused ? 'login__field--focused' : ''}`} onClick={() => focusInput('firstName')}>
          <Label className="login__input-wrapper">
            <div className="login__field-placeholder" style={{ marginTop: registerFirstNameFocused ? '-8.2875px' : '-9.75px', transformOrigin: 'left top', transform: registerFirstNameFocused ? 'scale(0.85) translateY(-33.6765px)' : 'none'}}>Όνομα</div>
        ...
        <div  className={`login__field login__field--placeholder-transition login__field--text ${registerLastNameFocused ? 'login__field--focused' : ''}`} onClick={() => focusInput('lastName')}>
          <Label className="login__input-wrapper">
            <div className="login__field-placeholder" style={{ marginTop: registerLastNameFocused ? '-8.2875px' : '-9.75px', transformOrigin: 'left top', transform: registerLastNameFocused ? 'scale(0.85) translateY(-33.6765px)' : 'none' }}>Επώνυμο</div>
        ...
        <div  className={`login__field login__field--placeholder-transition login__field--password login__field--has-toggler ${registerPasswordFocused ? 'login__field--focused' : ''}`} onClick={() => focusInput('password')}>
          <Label className="login__input-wrapper">
