    ...
    <div className="root__wrapper">
      <div className="root">
        ...
        <div className="deals-tabs">
          <Link className="deals-tabs__tab deals-tabs__tab--selected" href="/deals">Προσφορές</Link>
          <Link className="deals-tabs__tab" href="/deals/c">Ανά κατηγορία</Link>
          <Link className="deals-tabs__tab" href="/deals/my">Οι Προσφορές μου</Link>
          <Link className="deals-tabs__tab" href="/deals/m">Ανά κατάστημα</Link>
          <Link className="deals-tabs__tab" href="/deals/b">Ανά κατασκευαστή</Link>
        </div>
