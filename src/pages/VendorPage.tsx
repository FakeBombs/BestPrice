  ...
  <div class="scroll__clip">
    <div class="scroll__scroller">
      <div class="merchant-map__pops grid scroll__content">
        ...
        <div class="merchant-map__pop-wrapper ">
          <div class="merchant-map__pop pressable" data-id="1">
            <div class="merchant-map__pop-meta">
              <address itemprop="address" class="ui-kit__tertiary ui-kit__pb-2">
                Λεωφόρος Ηρακλείου 465, Ηράκλειο
              </address>
              <small class="ui-kit__small ui-kit__muted">Κατάστημα / Παραλαβή</small>
            </div>
          </div>
        </div>

        <div class="merchant-map__pop-wrapper ">
          <div class="merchant-map__pop pressable" data-id="2">
            <div class="merchant-map__pop-meta">
              <address itemprop="address" class="ui-kit__tertiary ui-kit__pb-2">
                Γρ. Λαμπράκη 67, Πειραιάς
              </address>
              <small class="ui-kit__small ui-kit__muted">Κατάστημα / Παραλαβή</small>
            </div>
          </div>
        ...
        <div class="merchant-map__pop-wrapper ">
          <div class="merchant-map__pop pressable" data-id="3">
            <div class="merchant-map__pop-meta">
              <address itemprop="address" class="ui-kit__tertiary ui-kit__pb-2">
                Λεωφ. Εθ. Αντιστάσεως 77, Ηράκλειο
              </address>
              <small class="ui-kit__small ui-kit__muted">Κατάστημα / Παραλαβή</small>
            </div>
          </div>
        ...
        <div class="merchant-map__pop-wrapper ">
          <div class="merchant-map__pop pressable" data-id="4">
            <div class="merchant-map__pop-meta">
              <address itemprop="address" class="ui-kit__tertiary ui-kit__pb-2">
                Αναγνώστου Γογονή 118, Χανιά
              </address>
              <small class="ui-kit__small ui-kit__muted">Κατάστημα</small>
            </div>
          </div>
        </div>

        <div class="merchant-map__pop-wrapper ">
          <div class="merchant-map__pop pressable" data-id="5">
            <div class="merchant-map__pop-meta">
              <address itemprop="address" class="ui-kit__tertiary ui-kit__pb-2">
                Λοχαγού Παγωμένου 13, Ιεράπετρα
              </address>
              <small class="ui-kit__small ui-kit__muted">Κατάστημα</small>
            </div>
          </div>
        ...
        <div class="merchant-map__pop-wrapper ">
          <div class="merchant-map__pop pressable" data-id="6">
            <div class="merchant-map__pop-meta">
              <address itemprop="address" class="ui-kit__tertiary ui-kit__pb-2">
                Φιλίππου 15, 65403, Καβάλα
              </address>
              <small class="ui-kit__small ui-kit__muted">Κατάστημα / Παραλαβή</small>
            </div>
          </div>
        ...
        <div class="merchant-map__pop-wrapper ">
          <div class="merchant-map__pop pressable" data-id="7">
            <div class="merchant-map__pop-meta">
              <address itemprop="address" class="ui-kit__tertiary ui-kit__pb-2">
                Ερμού 315-317, Μυτιλήνη
              </address>
              <small class="ui-kit__small ui-kit__muted">Κατάστημα / Παραλαβή</small>
            </div>
          </div>
        ...
        <div class="merchant-map__pop-wrapper ">
          <div class="merchant-map__pop pressable" data-id="8">
            <div class="merchant-map__pop-meta">
              <address itemprop="address" class="ui-kit__tertiary ui-kit__pb-2">
                Μιχαήλ Αγγελου 35, 45333, Ιωάννινα
              </address>
              <small class="ui-kit__small ui-kit__muted">Κατάστημα / Παραλαβή</small>
            </div>
          </div>
