          ...
          <div class="page-products">
            <aside class="page-products__filters">
              <div id="filters">
                ...
                <div class="filters__md-toggler" hidden="" role="button"><h5><svg aria-hidden="true" class="icon" width="18" height="18"><use xlink:href="/public/dist/images/icons/icons.svg#icon-filters-18"></use></svg>ΦΙΛΤΡΑ</h5></div>
                <button class="button button--outline" id="filters__scrollback" style="left: 194px; width: 240px;"><svg class="icon" aria-hidden="true" width="12" height="12"><use xlink:href="/public/dist/images/icons/icons.svg#icon-up-12"></use></svg><div>Φίλτρα</div></button>
