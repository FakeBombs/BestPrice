...
const Categories: React.FC = () => {
  ...
  // --- Rendering Functions (Defined after hooks and derived state) ---
  ...
  const renderPopularCategoriesSection = (subcategories: Category[]) => {
    ...
    // Sort the provided subcategories by popularity (descending product count)
    const popularToShow = [...subcategories] // Create a copy before sorting
        ...
        {!showProductsInsteadOfChildren ? (
          <>
            ...
            <div className="sections">
                {/* *** Popular Categories Section using Subcategories *** */}
