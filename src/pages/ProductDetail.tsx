                  ...
                  <header className="section__header">
                    ...
                    <div className="filter-wrapper">
                      <div data-count={product.prices.length} className="price-filters scroll__content">
                        ...
                        <label data-type="certified" data-tooltip="Εμφάνιση μόνο προϊόντων που παρέχονται από πιστοποιημένα καταστήματα" className="price-filters__filter"><input type="checkbox" /><svg aria-hidden="true" className="icon" width={12} height={12}><use href="/dist/images/icons/icons.svg#icon-certified-outline-12"></use></svg><span className="price-filters__label">Πιστοποιημένα</span></label><label data-type="boxnow" className="price-filters__filter"><input type="checkbox" /><span className="price-filters__label">Παράδοση με <svg aria-hidden="true" className="icon" width="100%" height="100%"><use href="/dist/images/icons/partners.svg#icon-boxnow"></use></svg></span></label>
                        ...
                        <label data-type="color" data-options='["desert","black","white","grey","gold"]' className="price-filters__filter is-inline"><input type="checkbox" /><span className="price-filters__label">Χρώμα</span></label>
