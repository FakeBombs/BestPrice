const elTranslations = {
  ...
  favorites: 'Αγαπημένα',                 recentlyViewed: 'Είδες πρόσφατα',
  ...
  "certified_label": "Πιστοποιημένα καταστήματα",         "certified_stores_title": "Πιστοποιημένα Καταστήματα",
  ...
  "remove_deals_filter": "Αφαίρεση φίλτρου 'Προσφορές'", "remove_certified_filter": "Αφαίρεση φίλτρου 'Πιστοποιημένα καταστήματα'",
  ...
  giftsForFemaleBabies: 'Δώρα για μωρά κορίτσια',
  giftsForMaleBabies: 'Δώρα για μωρά αγόρια',
