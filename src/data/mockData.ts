...
{ id: 140, name: 'Θήκες Κινητών Samsung', slug: 'samsung-mobile-cases', parentId: 10, image: '' },
{ id: 141, name: 'Θήκες Κινητών Xiaomi', slug: 'xiaomi-mobile-cases', parentId: 10, image: '' },
{ id: 142, name: 'Θήκες iPhone', slug: 'iphone-cases', parentId: 10, image: '' },
{ id: 143, name: 'Θήκες Κινητών Huawei', slug: 'huawei-mobile-cases', parentId: 10, image: '' },
{ id: 144, name: 'Θήκες Κινητών Nokia', slug: 'nokia-mobile-cases', parentId: 10, image: '' },
{ id: 145, name: 'Θήκες Κινητών Honor', slug: 'honor-mobile-cases', parentId: 10, image: '' },
{ id: 146, name: 'Θήκες Κινητών LG', slug: 'lg-mobile-cases', parentId: 10, image: '' },
{ id: 147, name: 'Θήκες Κινητών Sony', slug: 'sony-mobile-cases', parentId: 10, image: '' },
{ id: 148, name: 'Θήκες Κινητών MLS', slug: 'mls-mobile-cases', parentId: 10, image: '' },
{ id: 149, name: 'Θήκες Άλλων Κινητών', slug: 'other-mobile-cases', parentId: 10, image: '' },
{ id: 150, name: 'Θήκες Universal', slug: 'universal-cases', parentId: 10, image: '' },
{ id: 151, name: 'Θήκες Κινητών Πουγκί (Pouch)', slug: 'pouch-mobile-cases', parentId: 10, image: '' },
{ id: 152, name: 'Θήκες Κινητών για Τρέξιμο', slug: 'running-mobile-cases', parentId: 10, image: '' },
{ id: 153, name: 'Θήκες Κινητών με Σχέδια', slug: 'designed-mobile-cases', parentId: 10, image: '' },
{ id: 154, name: 'Αδιάβροχες Θήκες Κινητών', slug: 'waterproof-mobile-cases', parentId: 10, image: '' },
  
//Subcategories of Καλώδια Φόρτισης, Μεταφοράς Δεδομένων (Charging and Data Transfer Cables)
{ id: 155, name: 'Καλώδια USB Type-C', slug: 'usb-type-c-cables', parentId: 10, image: '' },
{ id: 156, name: 'Καλώδια Lightning', slug: 'lightning-cables', parentId: 10, image: '' },
{ id: 157, name: 'Καλώδια micro USB', slug: 'micro-usb-cables', parentId: 10, image: '' },
{ id: 158, name: 'Καλώδια Multi Port', slug: 'multi-port-cables', parentId: 10, image: '' },
{ id: 159, name: 'Καλώδια 30-Pin', slug: '30-pin-cables', parentId: 10, image: '' },
{ id: 160, name: 'Αντάπτορες, Προεκτάσεις Κινητών', slug: 'mobile-adapters-extensions', parentId: 10, image: '' },
  
//Subcategories of Ανταλλακτικά Κινητών (Mobile Spare Parts)
{ id: 161, name: 'Οθόνες Κινητών', slug: 'mobile-screens', parentId: 10, image: '' },
{ id: 162, name: 'Μηχανισμοί Δόνησης Κινητών', slug: 'mobile-vibration-mechanisms', parentId: 10, image: '' },
{ id: 163, name: 'Μηχανισμοί Αφής Κινητών', slug: 'mobile-touch-mechanisms', parentId: 10, image: '' },
{ id: 164, name: 'Καπάκια Κινητών', slug: 'mobile-covers', parentId: 10, image: '' },
{ id: 165, name: 'Πλήκτρα, Διακόπτες, Καλύμματα', slug: 'buttons-switches-covers', parentId: 10, image: '' },
{ id: 166, name: 'Ανταλλακτικά Ηχεία Κινητών', slug: 'mobile-speaker-parts', parentId: 10, image: '' },
{ id: 167, name: 'Charging Ports (Επαφές Φόρτισης)', slug: 'mobile-charging-ports', parentId: 10, image: '' },
{ id: 168, name: 'Κάμερες Κινητών', slug: 'mobile-cameras', parentId: 10, image: '' },
{ id: 169, name: 'Ανταλλακτικά για Ακουστικά Κινητών', slug: 'mobile-headphone-parts', parentId: 10, image: '' },
{ id: 170, name: 'Μικρόφωνα για Κινητά', slug: 'mobile-microphones', parentId: 10, image: '' },
{ id: 171, name: 'Προσόψεις Κινητών', slug: 'mobile-front-plates', parentId: 10, image: '' },
{ id: 172, name: 'Πλαίσια Κινητών', slug: 'mobile-frames', parentId: 10, image: '' },
{ id: 173, name: 'Κεραίες για Κινητά', slug: 'mobile-antennas', parentId: 10, image: '' },
{ id: 174, name: 'Βίδες για Κινητά', slug: 'mobile-screws', parentId: 10, image: '' },
{ id: 175, name: 'Καλωδιοταινίες', slug: 'flex-cables', parentId: 10, image: '' },
{ id: 176, name: 'SD/SIM Trays', slug: 'sd-sim-trays', parentId: 10, image: '' },
{ id: 177, name: 'Πλακέτες Πληκτρολογίου, Πληκτρολόγια', slug: 'keyboard-boards-keyboards', parentId: 10, image: '' },
{ id: 178, name: 'Διάφορα Ανταλλακτικά Κινητών', slug: 'various-mobile-parts', parentId: 10, image: '' },
