...
export const categories: Category[] = [
  ...
  { id: 130, name: 'Θήκες Κινητών Samsung', slug: 'samsung-mobile-cases', parentId: 104, image: '/dist/images/cat/samsung-mobile-cases.webp' },
  { id: 131, name: 'Θήκες Κινητών Xiaomi', slug: 'xiaomi-mobile-cases', parentId: 104, image: '/dist/images/cat/xiaomi-mobile-cases.webp' },
  { id: 132, name: 'Θήκες iPhone', slug: 'iphone-cases', parentId: 104, image: '/dist/images/cat/iphone-cases.webp' },
  { id: 133, name: 'Θήκες Κινητών Huawei', slug: 'huawei-mobile-cases', parentId: 104, image: '/dist/images/cat/huawei-mobile-cases.webp' },
  { id: 134, name: 'Θήκες Κινητών Nokia', slug: 'nokia-mobile-cases', parentId: 104, image: '/dist/images/cat/nokia-mobile-cases.webp' },
  { id: 135, name: 'Θήκες Κινητών Honor', slug: 'honor-mobile-cases', parentId: 104, image: '/dist/images/cat/honor-mobile-cases.webp' },
  { id: 136, name: 'Θήκες Κινητών LG', slug: 'lg-mobile-cases', parentId: 104, image: '/dist/images/cat/lg-mobile-cases.webp' },
  { id: 137, name: 'Θήκες Κινητών Sony', slug: 'sony-mobile-cases', parentId: 104, image: '/dist/images/cat/sony-mobile-cases.webp' },
  { id: 138, name: 'Θήκες Κινητών MLS', slug: 'mls-mobile-cases', parentId: 104, image: '/dist/images/cat/mls-mobile-cases.webp' },
  { id: 139, name: 'Θήκες Άλλων Κινητών', slug: 'other-mobile-cases', parentId: 104, image: '/dist/images/cat/other-mobile-cases.webp' },
  { id: 140, name: 'Θήκες Universal', slug: 'universal-cases', parentId: 104, image: '/dist/images/cat/universal-cases.webp' },
  { id: 141, name: 'Θήκες Κινητών Πουγκί (Pouch)', slug: 'pouch-mobile-cases', parentId: 104, image: '/dist/images/cat/pouch-mobile-cases.webp' },
  { id: 142, name: 'Θήκες Κινητών για Τρέξιμο', slug: 'running-mobile-cases', parentId: 104, image: '/dist/images/cat/running-mobile-cases.webp' },
  { id: 143, name: 'Θήκες Κινητών με Σχέδια', slug: 'designed-mobile-cases', parentId: 104, image: '/dist/images/cat/designed-mobile-cases.webp' },
  { id: 144, name: 'Αδιάβροχες Θήκες Κινητών', slug: 'waterproof-mobile-cases', parentId: 104, image: '/dist/images/cat/waterproof-mobile-cases.webp' },
  
  //Subcategories of Καλώδια Φόρτισης, Μεταφοράς Δεδομένων (Charging and Data Transfer Cables)
  { id: 145, name: 'Καλώδια USB Type-C', slug: 'usb-type-c-cables', parentId: 114, image: 'https://abpcdn.pstatic.gr/P/bpimg128/8854_SX400Y400/1714383272/kalodia-usb-type-c.webp' },
  { id: 146, name: 'Καλώδια Lightning', slug: 'lightning-cables', parentId: 114, image: 'https://abpcdn.pstatic.gr/P/bpimg128/8855_SX400Y400/1714381743/kalodia-lightning.webp' },
  { id: 147, name: 'Καλώδια micro USB', slug: 'micro-usb-cables', parentId: 114, image: 'https://abpcdn.pstatic.gr/P/bpimg128/8856_SX400Y400/1714382762/kalodia-micro-usb.webp' },
  { id: 148, name: 'Καλώδια Multi Port', slug: 'multi-port-cables', parentId: 114, image: 'https://abpcdn.pstatic.gr/P/bpimg128/8857_SX400Y400/1714384923/kalodia-multi-port.webp' },
  { id: 149, name: 'Καλώδια 30-Pin', slug: '30-pin-cables', parentId: 114, image: 'https://abpcdn.pstatic.gr/P/bpimg128/8858_SX400Y400/1714382229/kalodia-30-pin.webp' },
  { id: 150, name: 'Αντάπτορες, Προεκτάσεις Κινητών', slug: 'mobile-adapters-extensions', parentId: 114, image: 'https://abpcdn.pstatic.gr/P/bpimg128/8867_SX400Y400/1714385821/antaptores-proektaseis-kiniton.webp' },
