...
export const categories: Category[] = [
  ...
  { id: 222, name: 'Laptops', slug: 'laptops', parentId: 12, image: '/dist/images/cat/laptops.webp' },
  { id: 223, name: 'MacBook', slug: 'macbook', parentId: 12, image: '/dist/images/cat/macbook.webp' },
  { id: 224, name: 'Τσάντες Laptop', slug: 'laptop-bags', parentId: 12, image: '/dist/images/cat/laptop-bags.webp' },
  { id: 225, name: 'Καλύμματα Laptop', slug: 'laptop-skins', parentId: 12, image: '/dist/images/cat/laptop-skins.webp' },
  { id: 226, name: 'Φορτιστές Laptop', slug: 'laptop-chargers', parentId: 12, image: '/dist/images/cat/laptop-chargers.webp' },
  { id: 227, name: 'Μπαταρίες Laptop', slug: 'laptop-batteries', parentId: 12, image: '/dist/images/cat/laptop-batteries.webp' },
  { id: 228, name: 'Βάσεις Laptop', slug: 'laptop-stands', parentId: 12, image: '/dist/images/cat/laptop-stands.webp' },
  { id: 229, name: 'Docking Stations Laptop', slug: 'laptop-docking-stations', parentId: 12, image: '/dist/images/cat/laptop-docking-stations.webp' },
  { id: 230, name: 'Αυτοκόλλητα Laptop', slug: 'laptop-stickers', parentId: 12, image: '/dist/images/cat/laptop-stickers.webp' },
  { id: 231, name: 'Ανταλλακτικά Laptop', slug: 'laptop-parts', parentId: 12, image: '/dist/images/cat/laptop-parts.webp' },
  { id: 232, name: 'Κάρτες PCMCIA', slug: 'pcmcia-cards', parentId: 12, image: '/dist/images/cat/pcmcia-cards.webp' },
  { id: 233, name: 'Διάφορα Είδη Laptop', slug: 'misc-laptop-items', parentId: 12, image: '/dist/images/cat/misc-laptop-items.webp' },

  // Subcategories of Ανταλλακτικά Laptop of a Subcategory Laptops, Αξεσουάρ of Main Category Τεχνολογία
  { id: 234, name: 'Οθόνες Laptop', slug: 'laptop-screens', parentId: 231, image: '/dist/images/cat/laptop-screens.webp' },
  { id: 235, name: 'Πληκτρολόγια Laptop', slug: 'laptop-keyboards', parentId: 231, image: '/dist/images/cat/laptop-keyboards.webp' },
  { id: 236, name: 'Καλωδιοταινίες Laptop', slug: 'laptop-cables', parentId: 231, image: '/dist/images/cat/laptop-cables.webp' },
  { id: 237, name: 'Ανεμιστηράκια Laptop', slug: 'laptop-fans', parentId: 231, image: '/dist/images/cat/laptop-fans.webp' },
  { id: 238, name: 'Βύσματα Τροφοδοσίας Laptop', slug: 'laptop-power-connectors', parentId: 231, image: '/dist/images/cat/laptop-power-connectors.webp' },
  { id: 239, name: 'Πλαίσια Laptop', slug: 'laptop-frames', parentId: 231, image: '/dist/images/cat/laptop-frames.webp' },
  { id: 240, name: 'Μεντεσέδες Laptop', slug: 'laptop-hinges', parentId: 231, image: '/dist/images/cat/laptop-hinges.webp' },
  { id: 241, name: 'LCD Inverters Laptop', slug: 'laptop-lcd-inverters', parentId: 231, image: '/dist/images/cat/laptop-lcd-inverters.webp' },
  { id: 242, name: 'Διάφορα Ανταλλακτικά Laptop', slug: 'misc-laptop-parts', parentId: 231, image: '/dist/images/cat/misc-laptop-parts.webp' },

  // Subcategories of Εικόνα of Main Category Τεχνολογία
  { id: 243, name: 'Τηλεοράσεις, Αξεσουάρ', slug: 'televisions-accessories', parentId: 13, image: '/dist/images/cat/televisions-accessories.webp' },
  { id: 244, name: 'Καλώδια HDMI', slug: 'hdmi-cables', parentId: 13, image: '/dist/images/cat/hdmi-cables.webp' },
  { id: 245, name: 'Δορυφορική, Cable & DVB-T', slug: 'satellite-cable-dvb-t', parentId: 13, image: '/dist/images/cat/satellite-cable-dvb-t.webp' },
  { id: 246, name: 'Projectors, Αξεσουάρ', slug: 'projectors-accessories', parentId: 13, image: '/dist/images/cat/projectors-accessories.webp' },
  { id: 247, name: 'TV Box', slug: 'tv-box', parentId: 13, image: '/dist/images/cat/tv-box.webp' },
  { id: 248, name: 'Smart TV Stick', slug: 'smart-tv-stick', parentId: 13, image: '/dist/images/cat/smart-tv-stick.webp' },
  { id: 249, name: 'Φορητές Τηλεοράσεις', slug: 'portable-tvs', parentId: 13, image: '/dist/images/cat/portable-tvs.webp' },
  { id: 250, name: 'Φορητά DVD Player', slug: 'portable-dvd-players', parentId: 13, image: '/dist/images/cat/portable-dvd-players.webp' },
  { id: 251, name: 'DVD, Blu-Ray Players & Recorders', slug: 'dvd-blu-ray-players-recorders', parentId: 13, image: '/dist/images/cat/dvd-blu-ray-players-recorders.webp' },
  ...
  { id: 260, name: 'Ψηφιακοί Δέκτες Mpeg-4', slug: 'digital-receivers-mpeg4', parentId: 245, image: '/dist/images/cat/digital-receivers-mpeg4.webp' },
  { id: 261, name: 'Δορυφορικοί Αποκωδικοποιητές', slug: 'satellite-decoders', parentId: 245, image: '/dist/images/cat/satellite-decoders.webp' },
  { id: 262, name: 'Επίγειες Κεραίες', slug: 'terrestrial-antennas', parentId: 245, image: '/dist/images/cat/terrestrial-antennas.webp' },
  { id: 263, name: 'Ενισχυτές Κεραιών Τηλεοράσεων', slug: 'tv-antenna-amplifiers', parentId: 245, image: '/dist/images/cat/tv-antenna-amplifiers.webp' },
  { id: 264, name: 'Δορυφορικά Πιάτα, Αξεσουάρ', slug: 'satellite-dishes-accessories', parentId: 245, image: '/dist/images/cat/satellite-dishes-accessories.webp' },
  { id: 265, name: 'LNBs', slug: 'lnbs', parentId: 245, image: '/dist/images/cat/lnbs.webp' },
  { id: 266, name: 'Καλώδια, Βύσματα', slug: 'cables-connectors', parentId: 245, image: '/dist/images/cat/cables-connectors.webp' },
  { id: 267, name: 'Diseqc', slug: 'diseqc', parentId: 245, image: '/dist/images/cat/diseqc.webp' },
  { id: 268, name: 'Μίκτες, Πολυδιακόπτες, Διακλαδωτές', slug: 'mixers-multiswitches-splitters', parentId: 245, image: '/dist/images/cat/mixers-multiswitches-splitters.webp' },
  { id: 269, name: 'Αξεσουάρ Συστημάτων Λήψης', slug: 'reception-system-accessories', parentId: 245, image: '/dist/images/cat/reception-system-accessories.webp' },

  // Subcategories of Smartwatches, Wearables of Main Category Τεχνολογία
  { id: 270, name: 'Smartwatches', slug: 'smartwatches', parentId: 14, image: '/dist/images/cat/smartwatches.webp' },
  { id: 271, name: 'Λουράκια Smartwatch', slug: 'smartwatch-straps', parentId: 14, image: '/dist/images/cat/smartwatch-straps.webp' },
  { id: 272, name: 'Φορτιστές Smartwatch', slug: 'smartwatch-chargers', parentId: 14, image: '/dist/images/cat/smartwatch-chargers.webp' },
  { id: 273, name: 'Προστασία Οθόνης Smartwatch', slug: 'smartwatch-screen-protection', parentId: 14, image: '/dist/images/cat/smartwatch-screen-protection.webp' },
  { id: 274, name: 'Θήκες Smartwatch', slug: 'smartwatch-cases', parentId: 14, image: '/dist/images/cat/smartwatch-cases.webp' },
  { id: 275, name: 'Ζώνες Καρδιακών Παλμών', slug: 'heart-rate-straps', parentId: 14, image: '/dist/images/cat/heart-rate-straps.webp' },
  ...
  { id: 286, name: 'Ηλεκτρονικά Παιχνίδια', slug: 'electronic-games', parentId: 16, image: 'https://abpcdn.pstatic.gr/P/bpimg128/6488_SX400Y400/1472718489/ilektronika-paixnidia.webp' },
  { id: 287, name: 'Gaming Controllers', slug: 'gaming-controllers', parentId: 16, image: 'https://abpcdn.pstatic.gr/P/bpimg128/3440_SX400Y400/1472718489/xeiristiria-gamepads.webp' },
  { id: 288, name: 'Τιμονιέρες', slug: 'steering-wheels', parentId: 16, image: 'https://abpcdn.pstatic.gr/P/bpimg128/8247_SX400Y400/1629455540/timonieres.webp' },
  { id: 289, name: 'Joysticks', slug: 'joysticks', parentId: 16, image: 'https://abpcdn.pstatic.gr/P/bpimg128/8248_SX400Y400/1629455540/joysticks.webp' },
  { id: 290, name: 'Διάφορα Gaming', slug: 'various-gaming', parentId: 16, image: 'https://abpcdn.pstatic.gr/P/bpimg128/5940_SX400Y400/1472718489/diafora-gaming.webp' },
  { id: 291, name: 'Ανταλλακτικά Κονσολών', slug: 'console-parts', parentId: 16, image: 'https://abpcdn.pstatic.gr/P/bpimg128/6360_SX400Y400/1472718489/antallaktika-konsolwn.webp' },
  { id: 292, name: 'VR Headsets', slug: 'vr-headsets', parentId: 16, image: 'https://abpcdn.pstatic.gr/P/bpimg128/6665_SX400Y400/1629455525/vr-headsets.webp' },
  { id: 293, name: 'Φιγούρες Χαρακτήρων', slug: 'character-figures', parentId: 16, image: 'https://abpcdn.pstatic.gr/P/bpimg128/7068_SX400Y400/1484062068/character-figures.webp' },
  { id: 294, name: 'Game TimeCards', slug: 'game-timecards', parentId: 16, image: 'https://abpcdn.pstatic.gr/P/bpimg128/3558_SX400Y400/1472718489/timecards.webp' },
  { id: 295, name: 'Gaming Headsets', slug: 'gaming-headsets', parentId: 16, image: 'https://abpcdn.pstatic.gr/P/bpimg128/8066_SX400Y400/1629455538/gaming-headsets.webp' },
  { id: 296, name: 'Καρέκλες Gaming', slug: 'gaming-chairs', parentId: 16, image: 'https://abpcdn.pstatic.gr/P/bpimg128/7869_SX400Y400/1629455537/karekles-gaming.webp' },
  { id: 186, name: 'Κάρτες Γραφικών', slug: 'graphics-cards', parentId: 16, image: 'https://abpcdn.pstatic.gr/P/bpimg128/2613_SX400Y400/1629455497/kartes-grafikwn.webp' },
  { id: 297, name: 'Gaming Ποντίκια', slug: 'gaming-mice', parentId: 16, image: 'https://abpcdn.pstatic.gr/P/bpimg128/8493_SX400Y400/1640098609/gaming-pontikia.webp' },
  { id: 298, name: 'Gaming Πληκτρολόγια', slug: 'gaming-keyboards', parentId: 16, image: 'https://abpcdn.pstatic.gr/P/bpimg128/8501_SX400Y400/1646043267/gaming-pliktrologia.webp' },

  // Subcategories of Ηλεκτρονικά Παιχνίδια of a Subcategory Video Games of Main Category Τεχνολογία
  { id: 299, name: 'PS5 Games', slug: 'ps5-games', parentId: 282, image: 'https://abpcdn.pstatic.gr/P/bpimg128/8273_SX400Y400/1629455541/ps5-games.webp' },
  { id: 300, name: 'PS4 Games', slug: 'ps4-games', parentId: 282, image: 'https://abpcdn.pstatic.gr/P/bpimg128/6041_SX400Y400/1629455519/playstation-4-games.webp' },
  { id: 301, name: 'Xbox Series Games', slug: 'xbox-series-games', parentId: 282, image: 'https://abpcdn.pstatic.gr/P/bpimg128/8274_SX400Y400/1629455541/xbox-series-games.webp' },
  { id: 302, name: 'PC Games', slug: 'pc-games', parentId: 282, image: 'https://abpcdn.pstatic.gr/P/bpimg128/889_SX400Y400/1629455541/pc-games.webp' },
  { id: 303, name: 'Xbox One Games', slug: 'xbox-one-games', parentId: 282, image: 'https://abpcdn.pstatic.gr/P/bpimg128/6143_SX400Y400/1629455520/xbox-one-games.webp' },
  { id: 304, name: 'Nintendo Switch Games', slug: 'nintendo-switch-games', parentId: 282, image: 'https://abpcdn.pstatic.gr/P/bpimg128/7070_SX400Y400/1484917102/nintendo-switch-games.webp' },
  { id: 305, name: 'PS3 Games', slug: 'ps3-games', parentId: 282, image: 'https://abpcdn.pstatic.gr/P/bpimg128/891_SX400Y400/1629455542/playstation-3-games.webp' },
  { id: 306, name: 'Playstation 2 Games', slug: 'playstation-2-games', parentId: 282, image: 'https://abpcdn.pstatic.gr/P/bpimg128/890_SX400Y400/1629455541/playstation-2-games.webp' },
  { id: 307, name: 'Μεταχειρισμένα Παιχνίδια', slug: 'used-games', parentId: 282, image: 'https://abpcdn.pstatic.gr/P/bpimg128/6471_SX400Y400/1629455523/metaxeirismena-paixnidia.webp' },
  { id: 308, name: 'Xbox 360 Games', slug: 'xbox-360-games', parentId: 282, image: 'https://abpcdn.pstatic.gr/P/bpimg128/886_SX400Y400/1629455541/xbox-360-games.webp' },
  { id: 309, name: 'Nintendo Wii Games', slug: 'nintendo-wii-games', parentId: 282, image: 'https://abpcdn.pstatic.gr/P/bpimg128/888_SX400Y400/1629455541/nintendo-wii-games.webp' },
  { id: 310, name: 'Nintendo Wii U Games', slug: 'nintendo-wii-u-games', parentId: 282, image: 'https://abpcdn.pstatic.gr/P/bpimg128/5942_SX400Y400/1629455518/nintendo-wii-u-games.webp' },
  { id: 311, name: 'Nintendo 3DS Games', slug: 'nintendo-3ds-games', parentId: 282, image: 'https://abpcdn.pstatic.gr/P/bpimg128/5501_SX400Y400/1629455514/3ds-games.webp' },
  { id: 312, name: 'Nintendo DS Series Games', slug: 'nintendo-ds-series-games', parentId: 282, image: 'https://abpcdn.pstatic.gr/P/bpimg128/887_SX400Y400/1629455541/nintendo-ds-series-games.webp' },
  { id: 313, name: 'PSP Games', slug: 'psp-games', parentId: 282, image: 'https://abpcdn.pstatic.gr/P/bpimg128/892_SX400Y400/1629455541/psp-games.webp' },
  { id: 314, name: 'PS Vita Games', slug: 'ps-vita-games', parentId: 282, image: 'https://abpcdn.pstatic.gr/P/bpimg128/5871_SX400Y400/1629455516/ps-vita-games.webp' },
  { id: 315, name: 'GameCube Games', slug: 'gamecube-games', parentId: 282, image: 'https://abpcdn.pstatic.gr/P/bpimg128/896_SX400Y400/1629455541/gamecube-games.webp' },
  { id: 316, name: 'GameBoy Games', slug: 'gameboy-games', parentId: 282, image: 'https://abpcdn.pstatic.gr/P/bpimg128/2996_SX400Y400/1629455498/gameboy-games.webp' },
  { id: 317, name: 'Συλλεκτικά Video Games', slug: 'collectible-video-games', parentId: 282, image: 'https://abpcdn.pstatic.gr/P/bpimg128/2998_SX400Y400/1629455498/syllektika-video-games.webp' },

  // Subcategories of Ήχος of Main Category Τεχνολογία
  { id: 318, name: 'Home Audio', slug: 'home-audio', parentId: 17, image: 'https://abpcdn.pstatic.gr/P/bpimg128/704_SX400Y400/1629455531/home-audio.webp' },
  { id: 319, name: 'Επαγγελματικός Ήχος', slug: 'professional-sound', parentId: 17, image: 'https://abpcdn.pstatic.gr/P/bpimg128/3280_SX400Y400/1629455501/dj.webp' },
  { id: 320, name: 'Ακουστικά, Αξεσουάρ', slug: 'headphones-accessories', parentId: 17, image: 'https://abpcdn.pstatic.gr/P/bpimg128/2557_SX400Y400/1629455496/akoustika-aksesouar.webp' },
  { id: 321, name: 'Karaoke', slug: 'karaoke', parentId: 17, image: 'https://abpcdn.pstatic.gr/P/bpimg128/3304_SX400Y400/1476430484/karaoke.webp' },
  { id: 322, name: 'Συσκευές Πικάπ, Αξεσουάρ', slug: 'turntables-accessories', parentId: 17, image: 'https://abpcdn.pstatic.gr/P/bpimg128/3289_SX400Y400/1476430484/pickup-aksesouar.webp' },
  { id: 323, name: 'Home Cinema', slug: 'home-cinema', parentId: 17, image: 'https://abpcdn.pstatic.gr/P/bpimg128/692_SX400Y400/1629455530/home-cinema.webp' },
  { id: 324, name: 'Φορητές Συσκευές', slug: 'portable-devices', parentId: 17, image: 'https://abpcdn.pstatic.gr/P/bpimg128/719_SX400Y400/1629455532/portable.webp' },
  { id: 325, name: 'MP3, MP4 Players & Αξεσουάρ', slug: 'mp3-mp4-players-accessories', parentId: 17, image: 'https://abpcdn.pstatic.gr/P/bpimg128/713_SX400Y400/1629455531/mp3-players.webp' },
  { id: 326, name: 'Ηχεία Εγκαταστάσεων', slug: 'installation-speakers', parentId: 17, image: 'https://abpcdn.pstatic.gr/P/bpimg128/8569_SX400Y400/1663747970/ixeia-egkatastaseon.webp' },
  { id: 327, name: 'Αυτοενισχυόμενα Ηχεία', slug: 'powered-speakers', parentId: 17, image: 'https://abpcdn.pstatic.gr/P/bpimg128/8576_SX400Y400/1663748150/aytoenisxyomena-ixeia.webp' },
...
export const vendors: Vendor[] = [
  ...
  { 
    ...
    paymentMethods: [PaymentMethod.COD, PaymentMethod.CreditCard, PaymentMethod.BankTransfer, PaymentMethod.Courier, PaymentMethod.FreeReturn, PaymentMethod.GiftCards, PaymentMethod.ExtendedWarranty] 
  },
  { 
    id: 3, 
    name: 'Public', 
    ...
    paymentMethods: [PaymentMethod.COD, PaymentMethod.CreditCard, PaymentMethod.PayPal, PaymentMethod.BankTransfer, PaymentMethod.Courier, PaymentMethod.FreeReturn, PaymentMethod.PointsCollection, PaymentMethod.GiftCards, PaymentMethod.ExtendedWarranty, PaymentMethod.DeviceRecycling] 
  },
  { 
    id: 4, 
    name: 'Κωτσόβολος', 
