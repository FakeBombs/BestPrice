...
export const vendors: Vendor[] = [
  { id: '1', name: 'Best Buy', url: 'https://www.bestbuy.com/', logo: '/images/vendors/bestbuy.png', rating: 4.5, productCount: 1240, categoryCount: 25, certification: 'Certified Retailer' },
  { id: '2', name: 'Amazon', url: 'https://www.amazon.com/', logo: '/images/vendors/amazon.png', rating: 4.2, productCount: 5600, categoryCount: 42, certification: 'Premium Partner' },
  { id: '3', name: 'Walmart', url: 'https://www.walmart.com/', logo: '/images/vendors/walmart.png', rating: 3.9, productCount: 3450, categoryCount: 38, certification: 'Verified Seller' },
];
...
export const products = [
  {
    ...
    imageUrl: '/dist/images/products/smartphone.webp',
    ...
    slug: 'smartphone-x',
    prices: [
      { vendorId: '1', price: 999, inStock: true },
      { vendorId: '2', price: 989, inStock: true, shippingCost: 10 },
    ],
  },
  {
    id: '2',
    ...
    imageUrl: '/dist/images/products/laptop.webp',
    ...
    slug: 'laptop-pro',
    prices: [
      { vendorId: '1', price: 1499, inStock: true },
      { vendorId: '3', price: 1449, inStock: false },
    ],
  },
  {
    id: '3',
    ...
    imageUrl: '/dist/images/products/tv.webp',
    ...
    slug: 'smart-tv-4k',
    prices: [
      { vendorId: '2', price: 799, inStock: true },
    ],
  },
  {
    id: '4',
    ...
    imageUrl: '/dist/images/products/men-shirt.webp',
    ...
    prices: [
      { vendorId: '1', price: 49, inStock: true },
    ],
  },
  {
    id: '5',
    ...
    imageUrl: '/dist/images/products/women-dress.webp',
    ...
    prices: [
      { vendorId: '2', price: 79, inStock: true },
    ],
  },
  {
    id: '6',
    ...
    imageUrl: '/dist/images/products/sofa.webp',
    ...
    slug: 'modern-sofa',
    prices: [
      { vendorId: '3', price: 599, inStock: true },
    ],
  },
  {
    id: '7',
    ...
    imageUrl: '/dist/images/products/table.webp',
    ...
    slug: 'outdoor-table',
    prices: [
      { vendorId: '1', price: 199, inStock: true },
    ],
  },
  {
    id: '8',
    ...
    imageUrl: '/dist/images/products/serum.webp',
    ...
    prices: [
      { vendorId: '2', price: 39, inStock: true },
    ],
  },
  {
    id: '9',
    ...
    imageUrl: '/dist/images/products/lipstick.webp',
    ...
    slug: 'red-lipstick',
    prices: [
      { vendorId: '3', price: 29, inStock: true },
    ],
  },
  {
    id: '10',
    ...
    imageUrl: '/dist/images/products/dumbbells.webp',
    ...
    slug: 'dumbbells-set',
    prices: [
      { vendorId: '1', price: 149, inStock: true },
    ],
  },
  {
    id: '11',
    ...
    imageUrl: '/dist/images/products/tent.webp',
    ...
    slug: 'camping-tent',
    prices: [
      { vendorId: '2', price: 249, inStock: true },
    ],
  },
  {
    id: '12',
  ...
  },
  {
    ...
    slug: 'laptop-air',
    prices: [
      { vendorId: '1', price: 899, inStock: true },
    ],
  },
  {
    id: '14',
    ...
    slug: 'smart-tv-hd',
    prices: [
      { vendorId: '2', price: 399, inStock: true },
    ],
  },
  {
    id: '15',
    ...
    prices: [
      { vendorId: '3', price: 249, inStock: true },
    ],
  },
  {
    id: '16',
    ...
    prices: [
      { vendorId: '1', price: 349, inStock: true },
    ],
  },
  {
    id: '17',
    ...
    prices: [
      { vendorId: '2', price: 449, inStock: true },
    ],
  },
  {
    id: '18',
    ...
    slug: 'bbq-grill',
    prices: [
      { vendorId: '3', price: 99, inStock: true },
    ],
  },
  {
    id: '19',
  ...
  },
  {
    ...
    prices: [
      { vendorId: '2', price: 34, inStock: true },
    ],
  },
  {
    id: '21',
  ...
  },
  {
    ...
    prices: [
      { vendorId: '1', price: 79, inStock: true },
    ],
  },
];
...
// Export compatible functions for the services
...
export const fetchCategoryPath = async (categoryId: string): Promise<Category[]> => {
