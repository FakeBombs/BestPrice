...
// --- Products ---
// Ensuring optional OBJECTS (specifications, giftAttributes) are initialized to {}
...
export const products: Product[] = [
  ...
  },
  {
    ...
    giftAttributes: {}, // Example of no gift attributes
  },
  {
  ...
  // --- NEW Randomly Generated Products (IDs 21-50) - Ensuring mandatory arrays and some optional objects ---
  {
    ...
    giftAttributes: { recipient: ['men', 'women'], interest: ['coffee', 'kitchen', 'home'], occasion: ['housewarming', 'birthday'] }, images: [], videos: [], variants: [], tags: ['kitchen', 'appliance'], relatedProductIds: [], comparisonProductIds: []
  },
  {
    ...
    giftAttributes: { recipient: ['men', 'women', 'teens'], interest: ['tech', 'work', 'computers', 'travel'] }, images: [], videos: [], variants: [], tags: ['computer', 'mouse', 'portable'], relatedProductIds: [], comparisonProductIds: []
  },
  {
    ...
    giftAttributes: { recipient: ['men', 'women'], interest: ['travel'] }, images: [], videos: [], variants: [], tags: ['luggage', 'travel'], relatedProductIds: [], comparisonProductIds: []
  },
  {
    ...
    giftAttributes: { recipient: ['women', 'men'], interest: ['lego', 'home', 'decor', 'hobby'], occasion: ['birthday', 'mothersday'] }, images: [], videos: [], variants: [], tags: ['lego', 'adult', 'decor'], relatedProductIds: [], comparisonProductIds: []
  },
  {
    ...
    giftAttributes: { recipient: ['men'], interest: ['watches', 'fashion', 'accessories', 'automatic'], occasion: ['birthday', 'anniversary'] }, images: [], videos: [], variants: [], tags: ['watch', 'men', 'automatic'], relatedProductIds: [], comparisonProductIds: []
  },
  {
    ...
    giftAttributes: { recipient: ['men', 'women', 'teens'], interest: ['books', 'tech', 'reading'] }, images: [], videos: [], variants: [], tags: ['ebook', 'reader', 'tech'], relatedProductIds: [], comparisonProductIds: []
  },
  {
    ...
    giftAttributes: { recipient: ['men'], interest: ['grooming', 'tech', 'beauty'] }, images: [], videos: [], variants: [], tags: ['shaver', 'grooming', 'men'], relatedProductIds: [], comparisonProductIds: []
  },
  {
    ...
    giftAttributes: { recipient: ['men'], interest: ['perfume', 'luxury', 'fashion'], occasion: ['birthday', 'anniversary', 'christmas'] }, images: [], videos: [], variants: [], tags: ['fragrance', 'men', 'luxury'], relatedProductIds: [], comparisonProductIds: []
  },
  {
    ...
    giftAttributes: { recipient: ['men', 'women'], interest: ['health', 'gadgets', 'beauty'] }, images: [], videos: [], variants: [], tags: ['oralcare', 'health', 'tech'], relatedProductIds: [], comparisonProductIds: []
  },
  {
    ...
    giftAttributes: { recipient: ['men', 'women'], interest: ['bbq', 'cooking', 'outdoors', 'home', 'food'] }, images: [], videos: [], variants: [], tags: ['bbq', 'pizza', 'cooking'], relatedProductIds: [], comparisonProductIds: []
  },
  {
    ...
    giftAttributes: { recipient: ['women', 'men'], interest: ['cooking', 'kitchen', 'home'] }, images: [], videos: [], variants: [], tags: ['blender', 'kitchen', 'appliance'], relatedProductIds: [], comparisonProductIds: []
  },
  {
    ...
    giftAttributes: { recipient: ['women', 'men'], interest: ['home', 'smarthome', 'health'] }, images: [], videos: [], variants: [], tags: ['dehumidifier', 'home', 'appliance'], relatedProductIds: [], comparisonProductIds: []
  },
  {
  ...
  },
  {
    ...
    giftAttributes: { recipient: ['men', 'women'], interest: ['tech', 'smarthome', 'gadgets', 'home'] }, images: [], videos: [], variants: [], tags: ['robotvacuum', 'smarthome', 'tech'], relatedProductIds: [], comparisonProductIds: []
  },
  {
    ...
    giftAttributes: { recipient: ['women', 'men'], interest: ['home', 'decor'], occasion: ['wedding', 'housewarming'] }, images: [], videos: [], variants: [], tags: ['bedding', 'home', 'decor'], relatedProductIds: [], comparisonProductIds: []
  },
  {
    ...
    giftAttributes: { recipient: ['men', 'women', 'teens'], interest: ['music', 'tech', 'gadgets', 'outdoors'] }, images: [], videos: [], variants: [], tags: ['speaker', 'bluetooth', 'portable', 'audio'], relatedProductIds: [], comparisonProductIds: []
  },
  {
    ...
    giftAttributes: { recipient: ['men', 'women'], interest: ['coffee', 'kitchen', 'home'] }, images: [], videos: [], variants: [], tags: ['coffee', 'grinder', 'manual'], relatedProductIds: [], comparisonProductIds: []
  },
  {
  ...
  },
  {
    ...
    giftAttributes: { recipient: ['men', 'women'], interest: ['books', 'reading', 'history', 'science'] }, images: [], videos: [], variants: [], tags: ['book', 'history', 'nonfiction'], relatedProductIds: [], comparisonProductIds: []
  },
  {
    ...
    giftAttributes: { recipient: ['men', 'women'], interest: ['tech', 'computers', 'design', 'work'] }, images: [], videos: [], variants: [], tags: ['monitor', '4k', 'ips', 'professional'], relatedProductIds: [], comparisonProductIds: []
  },
  {
  ...
  },
  {
    ...
    giftAttributes: { recipient: ['men', 'teens'], interest: ['fashion', 'outdoors', 'clothing'] }, images: [], videos: [], variants: [], tags: ['jacket', 'outdoor', 'men'], relatedProductIds: [], comparisonProductIds: []
  },
  {
    ...
    giftAttributes: { recipient: ['men', 'women'], interest: ['travel'] }, images: [], videos: [], variants: [], tags: ['luggage', 'travel', 'set'], relatedProductIds: [], comparisonProductIds: []
  },
  {
    ...
    giftAttributes: { recipient: ['men', 'women', 'teens', 'kids9-11'], interest: ['fitness', 'outdoors', 'travel', 'home', 'eco'] }, images: [], videos: [], variants: [], tags: ['bottle', 'thermos', 'eco'], relatedProductIds: [], comparisonProductIds: []
  },
  {
  ...
  },
  {
    ...
    giftAttributes: { recipient: ['men', 'women', 'teens'], interest: ['tech', 'computers'] }, images: [], videos: [], variants: [], tags: ['storage', 'hdd', 'backup'], relatedProductIds: [], comparisonProductIds: []
  },
  {
  ...
  {
    id: 48, title: 'Κάμερα Οπισθοπορείας Αυτοκινήτου', slug: 'car-reverse-camera', brand: 'Generic', categoryIds: [98], // Car
    ...
    giftAttributes: { recipient: ['men'], interest: ['cars', 'gadgets', 'tech'] }, images: [], videos: [], variants: [], tags: ['car', 'camera', 'safety'], relatedProductIds: [], comparisonProductIds: []
  },
  {
    id: 49, title: 'Έξυπνη Πρίζα WiFi TP-Link Tapo P100', slug: 'tp-link-tapo-p100', brand: 'TP-Link', categoryIds: [21, 31], // Gadgets, Electrical Supplies
    ...
    giftAttributes: { recipient: ['men', 'women', 'teens'], interest: ['tech', 'smarthome', 'gadgets'] }, images: [], videos: [], variants: [], tags: ['smarthome', 'plug', 'wifi'], relatedProductIds: [], comparisonProductIds: []
  },
  {
    id: 50, title: 'Παιδικό Κάθισμα Αυτοκινήτου Isofix', slug: 'child-car-seat-isofix', brand: 'Chicco', categoryIds: [73, 98], // Baby Items, Car
    ...
    giftAttributes: { recipient: ['babies', 'toddlers'], interest: ['safety', 'baby'], occasion: ['baby-shower'] }, images: [], videos: [], variants: [], tags: ['carseat', 'baby', 'safety'], relatedProductIds: [], comparisonProductIds: []
  },
];
