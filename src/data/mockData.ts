...
// Add this to the end of your existing code in mockData.ts

// Make sure the product categories match exactly with the category names
export const products: Product[] = [
  {
    id: 'p1',
    title: 'Apple iPhone 14 Pro Max 256GB',
    brand: 'Apple',
    model: 'iPhone 14 Pro Max',
    category: 'Κινητά',  // Ensure this exists in the categories 
    description: 'The latest iPhone with a stunning design and powerful performance.',
    image: '//bbpcdn.pstatic.gr/bpimg0/78TKg/1SYzV1_SX660/1728492731/apple-iphone-14-pro-max-256gb.webp',
    images: [
      '//bbpcdn.pstatic.gr/bpimg0/78TKg/1SYzV1_SX660/1728492731/apple-iphone-14-pro-max-256gb.webp',
  ...
  // Make sure to add other products and change their categories accordingly
  {
    id: 'p2',
    title: 'Samsung Galaxy S23 Ultra 512GB',
    brand: 'Samsung',
    ...
    prices: [
      { vendorId: 'v1', price: 1199.99, shippingCost: 0, inStock: true },
      { vendorId: 'v2', price: 1219.99, shippingCost: 0, inStock: false },
      { vendorId: 'v3', price: 1169.99, shippingCost: 7.99, inStock: true }
    ]
  },

  // Add products with appropriate categories and ensure categories exist in the categories array
  // Make sure to add sample products for each subcategory like 'Laptops', 'Tablets', etc.
];
